...
int main()
{
	...
	int indexOfLargest = -1;// will store values larger in the array
	int indexOfSmallest = -1; //anything is larger than this
	int smallestFoundSoFar = 42069; //will store values smaller in the array
	...
	//prints off the largest and smallest integer values found and their correspoding index
	cout << "largestFoundSoFar=" << largestFoundSoFar << " at index " << indexOfLargest << endl;
    cout << "smallestFoundSoFar=" << smallestFoundSoFar << " at index " << indexOfSmallest << endl;
    return 0;
}